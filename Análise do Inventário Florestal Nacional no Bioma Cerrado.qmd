...
## Relação espacial entre os dados Bio do IFN e Sociológicos do IFN (Comentado)
...
## Quais são os tipos de usos presente na tabela Biofísico?
...
```{r}
tab_bio_taxon_ride %>%
  filter(scientificName == "Birsonima pachyphylla")
