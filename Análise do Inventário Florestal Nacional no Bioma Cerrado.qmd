...
## Contabilizar os tipos de usos mais frequentes por espécies
...
indices_espécies <- which(!duplicated(df_formatado_socio_uso$`NOME DESCRITO NO LSA`))

# Ajustando os índices para garantir que não ocorram problemas de 'out of range'
# A linha horizontal será inserida acima dessas linhas
indices_espécies_validos <- indices_espécies[indices_espécies > 1]
...
flex_formatado_socio_uso <- df_formatado_socio_uso %>%
  ...
  hline(i = indices_espécies_validos - 1,  # A linha horizontal é colocada acima do índice
        border = fp_border(color = "black", width = 1))

flex_formatado_socio_uso
